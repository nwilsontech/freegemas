...
struct Square{
    ...
    /// Vertical offset. This counts the number of positions this square has to fall
    int destY; 
...
/// Standard class to represent 2D Coordinates
struct coord{
...
// A group of matching squares
class Match : public vector<coord>{
public:

    /// Returns the coordinate of the square in the middle of the group
...
public:
    ...
    /// Default constructor. Generates the default board
    Board();
    ...
    /// Matrix of squares
    std::tr1::array<std::tr1::array<Square, 8>, 8> squares;
