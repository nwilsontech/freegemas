 ...
 * @class Animation
 *
 * @brief Calcula y devuelve valores para realizar animationes.
 *
 * El funcionamiento es sencillo. Creamos un objeto Animación al que le indicamos el
 ...
 \code
 Animation miAnimation (2, 30, Animation::tEaseInQuad, 0);
 \endcode
 ...
 miAnimation . set(0, 10, 150);

 // Parámetro 1 (la Y) de 25 a 40
 miAnimation . set(1, 25, 40);
 \endcode
 ...
 \code
 miAnimation . update();
 cout << "Posición horizontal: " << miAnimation.get(0) << "\n"
      << "Posición vertical: " << miAnimation.get(1) << endl;
\endcode
...
public:
    /// Diferentes tipos de animationes
...
public:
    ...
    Animation(int n, int d, tipoAnim anim = tEaseInQuad, int e = 0);
     ...
     */
    void setTipoAnimation(tipoAnim a);
